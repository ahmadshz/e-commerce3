                    ...
                    <form className='flex flex-col gap-2 sm:gap-[20px]  lg:py-4 px-6' onSubmit={handleSubmit}>
                        ...
                        <div className='flex flex-col xl:flex-row justify-between xl:items-center gap-2 lg:gap-4 xl:gap-2'>
                            ...
                            <input
                                ...
                                className='w-full xl:w-[433px] h-[60px] md:h-[76px] text-placeholder text-[15px] lg:text-[17px] 
                        ...
                        {/* Register Link */}
                        <Link to='/register' className='text-center text-placeholder text-[16px] lg:text-[20px] font-semibold p-2 lg:p-5'>
                            انشاء حساب جديد
                        </Link>
                    </form>
                </div>
