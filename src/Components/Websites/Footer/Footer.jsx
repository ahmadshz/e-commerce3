...
const Footer = () => {
    return (
        <div className='min-h-[40vh] container'>
            <div className='bg-primary h-70px text-white rounded-10px  py-2 md:py-4 lg:py-6 flex items-center justify-center text-center font-semibold text-[12px] lg:text-[16px] xl:text-[20px] '>دلّال هو المنصة المثالية التي تلبي جميع احتياجات الشعب السوري، معًا نبني سوريا المستقبل</div>
